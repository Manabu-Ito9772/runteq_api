RSpec.describe 'Api::V1::Articles', type: :request do
  describe 'GET /articles' do
    ...
    it 'returns fincle article in json format' do
      get api_v1_article_path(1), headers: { CONTENT_TYPE: 'application/json', ACCEPT: 'application/json', }

      expect(JSON.parse(body)['data'].count).to eq(4)
